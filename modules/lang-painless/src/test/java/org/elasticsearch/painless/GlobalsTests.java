...
public class GlobalsTests extends ScriptTestCase {
    ...
    public void testLoadStoreGlobals() {
        String script = "foo = 5.1; double qux; qux = foo + 2; return qux";
        Object result = exec(script, Map.of("abc", 124, "hij", 125), 99, 1.0, "", Collections.emptyMap());
        assertEquals(5.1 + 2, result);
        System.out.println(Debugger.toString(MockGlobalTestScript.class, script, new CompilerSettings(), Whitelist.BASE_WHITELISTS));
    }
